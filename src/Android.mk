...
ifeq ($(USE_THEORA),true)
LOCAL_C_INCLUDES_32 += \
	$(LOCAL_PATH)/theoraparser/include

LOCAL_LDFLAGS_32 += \
	-L$(LOCAL_PATH)/theoraparser/lib \
	-ltheoraparser_nougat
endif	
...
ifeq ($(USE_THEORA),true)
LOCAL_CFLAGS += -DENABLE_THEORA=1
else
LOCAL_CFLAGS += -DENABLE_THEORA=0
endif
