...
#else
			else if(  (codecId == AV_CODEC_ID_VC1) || (codecId == AV_CODEC_ID_WMV1) || (codecId == AV_CODEC_ID_WMV2) || (codecId == AV_CODEC_ID_WMV3) )
#endif				
			{
...
#else
			else if( codecId == AV_CODEC_ID_RV30 || codecId == AV_CODEC_ID_RV40 )
#endif				
			{
...
#else
			else if( codecId == AV_CODEC_ID_MSMPEG4V3 )
#endif				
			{
...
#else
	else if(  (codecId == AV_CODEC_ID_WMV1) || (codecId == AV_CODEC_ID_WMV2) || (codecId == AV_CODEC_ID_WMV3) )
#endif		
	{
#ifdef	RCV_V2	//	RCV_V2
...
#else
	else if( (stream->codec->codec_id == AV_CODEC_ID_RV40 || stream->codec->codec_id == AV_CODEC_ID_RV30 )
#endif		
...
#else
		if( AV_CODEC_ID_RV40 == stream->codec->codec_id )
#endif			
		{
...
#else
	else if( stream->codec->codec_id == AV_CODEC_ID_VP8 )
#endif		
	{
...
#else
	else if( stream->codec->codec_id == AV_CODEC_ID_THEORA )
#endif		
	{
printf("############ Theora:  __LINE__(%d)\n",__LINE__);
		ThoScaleInfo thoScaleInfo;
printf("############ Theora:  __LINE__(%d),stream->codec->extradata_size(%d)\n",__LINE__,stream->codec->extradata_size);
